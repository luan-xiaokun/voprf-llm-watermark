...
def main():
    ...
    p_value_dict = {window_size: [] for window_size in window_sizes}
    ...
    data_line1 = lines[0]
    data_line1.set_marker(".")  # 将标记形状设置为小点
    data_line1.set_markersize(3.0)  # 设置标记尺寸
    data_line1.set_markerfacecolor("tab:blue")  # 设置点的颜色
    data_line1.set_markeredgecolor("tab:blue")  # 设置点边缘的颜色
    data_line1.set_alpha(0.8)  # 设置透明度为30%
    data_line1.set_label(r"$h=4$")

    data_line2 = lines[1]
    data_line2.set_marker(".")  # 将标记形状设置为小点
    data_line2.set_markersize(3.0)  # 设置标记尺寸
    data_line2.set_markerfacecolor("tab:orange")  # 设置点的颜色
    data_line2.set_markeredgecolor("tab:orange")  # 设置点边缘的颜色
    data_line2.set_alpha(0.8)  # 设置透明度为30%
